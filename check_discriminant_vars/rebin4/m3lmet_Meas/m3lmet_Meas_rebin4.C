...
//=========  (Thu Dec 15 19:57:57 2022) by ROOT version 6.12/07
   TCanvas *m3lmet_Meas_rebin4_canvas = new TCanvas("m3lmet_Meas_rebin4_canvas", "m3lmet_Meas_rebin4",0,0,600,750);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   m3lmet_Meas_rebin4_canvas->SetHighLightColor(2);
   m3lmet_Meas_rebin4_canvas->Range(0,0,1,1);
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-115.3846,-31.16976,525.641,1215.621);
   pad1->SetFillColor(0);
   ...
   m3lmet_Meas_rebin4_total__1->SetBinContent(1,136.6665);
   m3lmet_Meas_rebin4_total__1->SetBinContent(2,358.9898);
   m3lmet_Meas_rebin4_total__1->SetBinContent(3,429.8815);
   m3lmet_Meas_rebin4_total__1->SetBinContent(4,570.4067);
   m3lmet_Meas_rebin4_total__1->SetBinError(1,8.808371);
   m3lmet_Meas_rebin4_total__1->SetBinError(2,9.486133);
   m3lmet_Meas_rebin4_total__1->SetBinError(3,9.223873);
   m3lmet_Meas_rebin4_total__1->SetBinError(4,8.871992);
   m3lmet_Meas_rebin4_total__1->SetMinimum(0);
   m3lmet_Meas_rebin4_total__1->SetMaximum(1140.813);
   m3lmet_Meas_rebin4_total__1->SetEntries(15152);
   ...
   m3lmet_Meas_rebin4_total__1->GetXaxis()->SetLabelOffset(999);
   m3lmet_Meas_rebin4_total__1->GetXaxis()->SetLabelSize(0.05);
   m3lmet_Meas_rebin4_total__1->GetXaxis()->SetTitleSize(0.05);
   m3lmet_Meas_rebin4_total__1->GetXaxis()->SetTitleOffset(999);
   ...
   m3lmet_Meas_rebin4_total__1->GetYaxis()->SetTitleSize(0.06);
   m3lmet_Meas_rebin4_total__1->GetYaxis()->SetTitleOffset(1.48);
   ...
   m3lmet_Meas_rebin4_stack_stack_1->SetMaximum(598.927);
   ...
   m3lmet_Meas_rebin4_fakes_VV_stack_1->SetBinContent(2,0.2915801);
   m3lmet_Meas_rebin4_fakes_VV_stack_1->SetBinContent(4,0.3887735);
   m3lmet_Meas_rebin4_fakes_VV_stack_1->SetBinError(2,0.1683439);
   m3lmet_Meas_rebin4_fakes_VV_stack_1->SetBinError(4,0.1943867);
   ...
   m3lmet_Meas_rebin4_fakes_TT_stack_2->SetBinContent(1,4.816373);
   m3lmet_Meas_rebin4_fakes_TT_stack_2->SetBinContent(2,11.90247);
   m3lmet_Meas_rebin4_fakes_TT_stack_2->SetBinContent(3,15.89212);
   m3lmet_Meas_rebin4_fakes_TT_stack_2->SetBinContent(4,22.43337);
   m3lmet_Meas_rebin4_fakes_TT_stack_2->SetBinError(1,0.5880996);
   m3lmet_Meas_rebin4_fakes_TT_stack_2->SetBinError(2,0.8896321);
   m3lmet_Meas_rebin4_fakes_TT_stack_2->SetBinError(3,1.036542);
   m3lmet_Meas_rebin4_fakes_TT_stack_2->SetBinError(4,1.236308);
   m3lmet_Meas_rebin4_fakes_TT_stack_2->SetEntries(841);
   ...
   m3lmet_Meas_rebin4_fakes_DY_stack_3->SetBinContent(1,39.54901);
   m3lmet_Meas_rebin4_fakes_DY_stack_3->SetBinContent(2,34.39044);
   m3lmet_Meas_rebin4_fakes_DY_stack_3->SetBinContent(3,27.51235);
   m3lmet_Meas_rebin4_fakes_DY_stack_3->SetBinContent(4,15.4757);
   m3lmet_Meas_rebin4_fakes_DY_stack_3->SetBinError(1,8.246538);
   m3lmet_Meas_rebin4_fakes_DY_stack_3->SetBinError(2,7.689937);
   m3lmet_Meas_rebin4_fakes_DY_stack_3->SetBinError(3,6.878088);
   m3lmet_Meas_rebin4_fakes_DY_stack_3->SetBinError(4,5.158566);
   m3lmet_Meas_rebin4_fakes_DY_stack_3->SetEntries(72);
   ...
   m3lmet_Meas_rebin4_prompt_ZZ_stack_4->SetBinContent(1,9.541241);
   m3lmet_Meas_rebin4_prompt_ZZ_stack_4->SetBinContent(2,19.08248);
   m3lmet_Meas_rebin4_prompt_ZZ_stack_4->SetBinContent(3,18.71551);
   m3lmet_Meas_rebin4_prompt_ZZ_stack_4->SetBinContent(4,25.87144);
   m3lmet_Meas_rebin4_prompt_ZZ_stack_4->SetBinError(1,1.323132);
   m3lmet_Meas_rebin4_prompt_ZZ_stack_4->SetBinError(2,1.871191);
   m3lmet_Meas_rebin4_prompt_ZZ_stack_4->SetBinError(3,1.853112);
   m3lmet_Meas_rebin4_prompt_ZZ_stack_4->SetBinError(4,2.178769);
   m3lmet_Meas_rebin4_prompt_ZZ_stack_4->SetEntries(403);
   ...
   m3lmet_Meas_rebin4_prompt_WZ_stack_5->SetBinContent(1,82.75991);
   m3lmet_Meas_rebin4_prompt_WZ_stack_5->SetBinContent(2,293.3228);
   m3lmet_Meas_rebin4_prompt_WZ_stack_5->SetBinContent(3,367.7615);
   m3lmet_Meas_rebin4_prompt_WZ_stack_5->SetBinContent(4,506.2374);
   m3lmet_Meas_rebin4_prompt_WZ_stack_5->SetBinError(1,2.735958);
   m3lmet_Meas_rebin4_prompt_WZ_stack_5->SetBinError(2,5.150773);
   m3lmet_Meas_rebin4_prompt_WZ_stack_5->SetBinError(3,5.767434);
   m3lmet_Meas_rebin4_prompt_WZ_stack_5->SetBinError(4,6.766695);
   m3lmet_Meas_rebin4_prompt_WZ_stack_5->SetEntries(13825);
   ...
   m3lmet_Meas_rebin4_total__2->SetBinContent(1,136.6665);
   m3lmet_Meas_rebin4_total__2->SetBinContent(2,358.9898);
   m3lmet_Meas_rebin4_total__2->SetBinContent(3,429.8815);
   m3lmet_Meas_rebin4_total__2->SetBinContent(4,570.4067);
   m3lmet_Meas_rebin4_total__2->SetBinError(1,8.808371);
   m3lmet_Meas_rebin4_total__2->SetBinError(2,9.486133);
   m3lmet_Meas_rebin4_total__2->SetBinError(3,9.223873);
   m3lmet_Meas_rebin4_total__2->SetBinError(4,8.871992);
   m3lmet_Meas_rebin4_total__2->SetMinimum(0);
   m3lmet_Meas_rebin4_total__2->SetMaximum(1140.813);
   m3lmet_Meas_rebin4_total__2->SetEntries(15152);
   ...
   m3lmet_Meas_rebin4_total__2->GetXaxis()->SetLabelOffset(999);
   m3lmet_Meas_rebin4_total__2->GetXaxis()->SetLabelSize(0.05);
   m3lmet_Meas_rebin4_total__2->GetXaxis()->SetTitleSize(0.05);
   m3lmet_Meas_rebin4_total__2->GetXaxis()->SetTitleOffset(999);
   ...
   m3lmet_Meas_rebin4_total__2->GetYaxis()->SetTitleSize(0.06);
   m3lmet_Meas_rebin4_total__2->GetYaxis()->SetTitleOffset(1.48);
   ...
   Graph_m3lmet_Meas_rebin4_total_errors3001->SetMinimum(82.71611);
   Graph_m3lmet_Meas_rebin4_total_errors3001->SetMaximum(624.4207);
   ...
   Double_t m3lmet_Meas_rebin4_data_graph_fx3002[4] = {
   95.43037,
   212.5408,
   261.7748,
   394.6644};
   Double_t m3lmet_Meas_rebin4_data_graph_fy3002[4] = {
   151,
   353,
   427,
   582};
   Double_t m3lmet_Meas_rebin4_data_graph_felx3002[4] = {
   95.43037,
   21.68005,
   27.55393,
   105.3356};
   Double_t m3lmet_Meas_rebin4_data_graph_fely3002[4] = {
   12.27484,
   18.7798,
   20.65633,
   24.11826};
   Double_t m3lmet_Meas_rebin4_data_graph_fehx3002[4] = {
   95.43037,
   21.68005,
   27.55393,
   105.3356};
   Double_t m3lmet_Meas_rebin4_data_graph_fehy3002[4] = {
   13.31564,
   19.80647,
   21.68059,
   25.13904};
   grae = new TGraphAsymmErrors(4,m3lmet_Meas_rebin4_data_graph_fx3002,m3lmet_Meas_rebin4_data_graph_fy3002,m3lmet_Meas_rebin4_data_graph_felx3002,m3lmet_Meas_rebin4_data_graph_fehx3002,m3lmet_Meas_rebin4_data_graph_fely3002,m3lmet_Meas_rebin4_data_graph_fehy3002);
   grae->SetName("m3lmet_Meas_rebin4_data_graph");
   grae->SetTitle("Graph");
   grae->SetFillStyle(1000);
   grae->SetMarkerStyle(20);
   grae->SetMarkerSize(1.1);
   
   TH1F *Graph_m3lmet_Meas_rebin4_data_graph3002 = new TH1F("Graph_m3lmet_Meas_rebin4_data_graph3002","Graph",100,0,550);
   Graph_m3lmet_Meas_rebin4_data_graph3002->SetMinimum(91.88377);
   Graph_m3lmet_Meas_rebin4_data_graph3002->SetMaximum(653.9804);
   Graph_m3lmet_Meas_rebin4_data_graph3002->SetDirectory(0);
   Graph_m3lmet_Meas_rebin4_data_graph3002->SetStats(0);
   Graph_m3lmet_Meas_rebin4_data_graph3002->SetLineStyle(0);
   Graph_m3lmet_Meas_rebin4_data_graph3002->SetMarkerStyle(20);
   Graph_m3lmet_Meas_rebin4_data_graph3002->GetXaxis()->SetLabelFont(42);
   Graph_m3lmet_Meas_rebin4_data_graph3002->GetXaxis()->SetLabelOffset(0.007);
   Graph_m3lmet_Meas_rebin4_data_graph3002->GetXaxis()->SetLabelSize(0.05);
   Graph_m3lmet_Meas_rebin4_data_graph3002->GetXaxis()->SetTitleSize(0.06);
   Graph_m3lmet_Meas_rebin4_data_graph3002->GetXaxis()->SetTitleOffset(0.9);
   Graph_m3lmet_Meas_rebin4_data_graph3002->GetXaxis()->SetTitleFont(42);
   Graph_m3lmet_Meas_rebin4_data_graph3002->GetYaxis()->SetLabelFont(42);
   Graph_m3lmet_Meas_rebin4_data_graph3002->GetYaxis()->SetLabelOffset(0.007);
   Graph_m3lmet_Meas_rebin4_data_graph3002->GetYaxis()->SetLabelSize(0.05);
   Graph_m3lmet_Meas_rebin4_data_graph3002->GetYaxis()->SetTitleSize(0.06);
   Graph_m3lmet_Meas_rebin4_data_graph3002->GetYaxis()->SetTitleOffset(1.35);
   Graph_m3lmet_Meas_rebin4_data_graph3002->GetYaxis()->SetTitleFont(42);
   Graph_m3lmet_Meas_rebin4_data_graph3002->GetZaxis()->SetLabelFont(42);
   Graph_m3lmet_Meas_rebin4_data_graph3002->GetZaxis()->SetLabelOffset(0.007);
   Graph_m3lmet_Meas_rebin4_data_graph3002->GetZaxis()->SetLabelSize(0.05);
   Graph_m3lmet_Meas_rebin4_data_graph3002->GetZaxis()->SetTitleSize(0.06);
   Graph_m3lmet_Meas_rebin4_data_graph3002->GetZaxis()->SetTitleFont(42);
   grae->SetHistogram(Graph_m3lmet_Meas_rebin4_data_graph3002);
   ...
   TLegendEntry *entry=leg->AddEntry("m3lmet_Meas_rebin4_data","Data","LPE");
   ...
   entry=leg->AddEntry("m3lmet_Meas_rebin4_prompt_WZ_stack_5","WZ","F");
...
// ------------>Primitives in pad: pad2
   ...
   Double_t xAxis9[5] = {0, 190.8607, 234.2208, 289.3287, 500}; 
   
   TH1D *m3lmet_Meas_rebin4_total__3 = new TH1D("m3lmet_Meas_rebin4_total__3","dummy",4, xAxis9);
   m3lmet_Meas_rebin4_total__3->SetBinContent(1,1);
   m3lmet_Meas_rebin4_total__3->SetBinContent(2,1);
   m3lmet_Meas_rebin4_total__3->SetBinContent(3,1);
   m3lmet_Meas_rebin4_total__3->SetBinContent(4,1);
   m3lmet_Meas_rebin4_total__3->SetMinimum(0.5);
   m3lmet_Meas_rebin4_total__3->SetMaximum(2);
   m3lmet_Meas_rebin4_total__3->SetEntries(15156);

   ci = TColor::GetColor("#00cc00");
   m3lmet_Meas_rebin4_total__3->SetFillColor(ci);

   ci = TColor::GetColor("#6666ff");
   m3lmet_Meas_rebin4_total__3->SetMarkerColor(ci);
   m3lmet_Meas_rebin4_total__3->SetMarkerSize(1.1);
   m3lmet_Meas_rebin4_total__3->GetXaxis()->SetTitle("m3lmet_Meas");
   m3lmet_Meas_rebin4_total__3->GetXaxis()->SetMoreLogLabels();
   m3lmet_Meas_rebin4_total__3->GetXaxis()->SetLabelFont(42);
   m3lmet_Meas_rebin4_total__3->GetXaxis()->SetLabelOffset(0.015);
   m3lmet_Meas_rebin4_total__3->GetXaxis()->SetLabelSize(0.1);
   m3lmet_Meas_rebin4_total__3->GetXaxis()->SetTitleSize(0.14);
   m3lmet_Meas_rebin4_total__3->GetXaxis()->SetTitleFont(42);
   m3lmet_Meas_rebin4_total__3->GetYaxis()->SetTitle("Data/pred.");
   m3lmet_Meas_rebin4_total__3->GetYaxis()->SetDecimals();
   m3lmet_Meas_rebin4_total__3->GetYaxis()->SetNdivisions(505);
   m3lmet_Meas_rebin4_total__3->GetYaxis()->SetLabelFont(42);
   m3lmet_Meas_rebin4_total__3->GetYaxis()->SetLabelOffset(0.01);
   m3lmet_Meas_rebin4_total__3->GetYaxis()->SetLabelSize(0.11);
   m3lmet_Meas_rebin4_total__3->GetYaxis()->SetTitleSize(0.14);
   m3lmet_Meas_rebin4_total__3->GetYaxis()->SetTitleOffset(0.62);
   m3lmet_Meas_rebin4_total__3->GetYaxis()->SetTitleFont(42);
   m3lmet_Meas_rebin4_total__3->GetZaxis()->SetLabelFont(42);
   m3lmet_Meas_rebin4_total__3->GetZaxis()->SetLabelOffset(0.007);
   m3lmet_Meas_rebin4_total__3->GetZaxis()->SetLabelSize(0.05);
   m3lmet_Meas_rebin4_total__3->GetZaxis()->SetTitleSize(0.06);
   m3lmet_Meas_rebin4_total__3->GetZaxis()->SetTitleFont(42);
   m3lmet_Meas_rebin4_total__3->Draw("AXIS");
   
   Double_t m3lmet_Meas_rebin4_total_errors_fx3003[4] = {
   95.43037,
   212.5408,
   261.7748,
   394.6644};
   Double_t m3lmet_Meas_rebin4_total_errors_fy3003[4] = {
   1,
   1,
   1,
   1};
   Double_t m3lmet_Meas_rebin4_total_errors_felx3003[4] = {
   95.43037,
   21.68005,
   27.55393,
   105.3356};
   Double_t m3lmet_Meas_rebin4_total_errors_fely3003[4] = {
   0.06445156,
   0.02642452,
   0.02145678,
   0.0155538};
   Double_t m3lmet_Meas_rebin4_total_errors_fehx3003[4] = {
   95.43037,
   21.68005,
   27.55393,
   105.3356};
   Double_t m3lmet_Meas_rebin4_total_errors_fehy3003[4] = {
   0.06445156,
   0.02642452,
   0.02145678,
   0.0155538};
   grae = new TGraphAsymmErrors(4,m3lmet_Meas_rebin4_total_errors_fx3003,m3lmet_Meas_rebin4_total_errors_fy3003,m3lmet_Meas_rebin4_total_errors_felx3003,m3lmet_Meas_rebin4_total_errors_fehx3003,m3lmet_Meas_rebin4_total_errors_fely3003,m3lmet_Meas_rebin4_total_errors_fehy3003);
   grae->SetName("m3lmet_Meas_rebin4_total_errors");
   grae->SetTitle("Graph");
   ...
   Double_t m3lmet_Meas_rebin4_total_errors_fx3004[4] = {
   95.43037,
   212.5408,
   261.7748,
   394.6644};
   Double_t m3lmet_Meas_rebin4_total_errors_fy3004[4] = {
   1,
   1,
   1,
   1};
   Double_t m3lmet_Meas_rebin4_total_errors_felx3004[4] = {
   95.43037,
   21.68005,
   27.55393,
   105.3356};
   Double_t m3lmet_Meas_rebin4_total_errors_fely3004[4] = {
   0.06445156,
   0.02642452,
   0.02145678,
   0.0155538};
   Double_t m3lmet_Meas_rebin4_total_errors_fehx3004[4] = {
   95.43037,
   21.68005,
   27.55393,
   105.3356};
   Double_t m3lmet_Meas_rebin4_total_errors_fehy3004[4] = {
   0.06445156,
   0.02642452,
   0.02145678,
   0.0155538};
   grae = new TGraphAsymmErrors(4,m3lmet_Meas_rebin4_total_errors_fx3004,m3lmet_Meas_rebin4_total_errors_fy3004,m3lmet_Meas_rebin4_total_errors_felx3004,m3lmet_Meas_rebin4_total_errors_fehx3004,m3lmet_Meas_rebin4_total_errors_fely3004,m3lmet_Meas_rebin4_total_errors_fehy3004);
   grae->SetName("m3lmet_Meas_rebin4_total_errors");
   grae->SetTitle("Graph");
   ...
   grae->SetMarkerColor(ci);
   grae->Draw("e2 ");
   Double_t xAxis10[5] = {0, 190.8607, 234.2208, 289.3287, 500}; 
   
   TH1D *m3lmet_Meas_rebin4_total__4 = new TH1D("m3lmet_Meas_rebin4_total__4","dummy",4, xAxis10);
   m3lmet_Meas_rebin4_total__4->SetBinContent(1,1);
   m3lmet_Meas_rebin4_total__4->SetBinContent(2,1);
   m3lmet_Meas_rebin4_total__4->SetBinContent(3,1);
   m3lmet_Meas_rebin4_total__4->SetBinContent(4,1);
   m3lmet_Meas_rebin4_total__4->SetMinimum(0.5);
   m3lmet_Meas_rebin4_total__4->SetMaximum(2);
   m3lmet_Meas_rebin4_total__4->SetEntries(15156);

   ci = TColor::GetColor("#00cc00");
   m3lmet_Meas_rebin4_total__4->SetFillColor(ci);

   ci = TColor::GetColor("#6666ff");
   m3lmet_Meas_rebin4_total__4->SetMarkerColor(ci);
   m3lmet_Meas_rebin4_total__4->SetMarkerSize(1.1);
   m3lmet_Meas_rebin4_total__4->GetXaxis()->SetTitle("m3lmet_Meas");
   m3lmet_Meas_rebin4_total__4->GetXaxis()->SetMoreLogLabels();
   m3lmet_Meas_rebin4_total__4->GetXaxis()->SetLabelFont(42);
   m3lmet_Meas_rebin4_total__4->GetXaxis()->SetLabelOffset(0.015);
   m3lmet_Meas_rebin4_total__4->GetXaxis()->SetLabelSize(0.1);
   m3lmet_Meas_rebin4_total__4->GetXaxis()->SetTitleSize(0.14);
   m3lmet_Meas_rebin4_total__4->GetXaxis()->SetTitleFont(42);
   m3lmet_Meas_rebin4_total__4->GetYaxis()->SetTitle("Data/pred.");
   m3lmet_Meas_rebin4_total__4->GetYaxis()->SetDecimals();
   m3lmet_Meas_rebin4_total__4->GetYaxis()->SetNdivisions(505);
   m3lmet_Meas_rebin4_total__4->GetYaxis()->SetLabelFont(42);
   m3lmet_Meas_rebin4_total__4->GetYaxis()->SetLabelOffset(0.01);
   m3lmet_Meas_rebin4_total__4->GetYaxis()->SetLabelSize(0.11);
   m3lmet_Meas_rebin4_total__4->GetYaxis()->SetTitleSize(0.14);
   m3lmet_Meas_rebin4_total__4->GetYaxis()->SetTitleOffset(0.62);
   m3lmet_Meas_rebin4_total__4->GetYaxis()->SetTitleFont(42);
   m3lmet_Meas_rebin4_total__4->GetZaxis()->SetLabelFont(42);
   m3lmet_Meas_rebin4_total__4->GetZaxis()->SetLabelOffset(0.007);
   m3lmet_Meas_rebin4_total__4->GetZaxis()->SetLabelSize(0.05);
   m3lmet_Meas_rebin4_total__4->GetZaxis()->SetTitleSize(0.06);
   m3lmet_Meas_rebin4_total__4->GetZaxis()->SetTitleFont(42);
   m3lmet_Meas_rebin4_total__4->Draw("AXIS SAME");
   ...
   TH1F *Graph_m3lmet_Meas_rebin4_data_graph3005 = new TH1F("Graph_m3lmet_Meas_rebin4_data_graph3005","Graph",100,0,550);
   Graph_m3lmet_Meas_rebin4_data_graph3005->SetMinimum(91.88377);
   Graph_m3lmet_Meas_rebin4_data_graph3005->SetMaximum(653.9804);
   Graph_m3lmet_Meas_rebin4_data_graph3005->SetDirectory(0);
   Graph_m3lmet_Meas_rebin4_data_graph3005->SetStats(0);
   Graph_m3lmet_Meas_rebin4_data_graph3005->SetLineStyle(0);
   Graph_m3lmet_Meas_rebin4_data_graph3005->SetMarkerStyle(20);
   Graph_m3lmet_Meas_rebin4_data_graph3005->GetXaxis()->SetLabelFont(42);
   Graph_m3lmet_Meas_rebin4_data_graph3005->GetXaxis()->SetLabelOffset(0.007);
   Graph_m3lmet_Meas_rebin4_data_graph3005->GetXaxis()->SetLabelSize(0.05);
   Graph_m3lmet_Meas_rebin4_data_graph3005->GetXaxis()->SetTitleSize(0.06);
   Graph_m3lmet_Meas_rebin4_data_graph3005->GetXaxis()->SetTitleOffset(0.9);
   Graph_m3lmet_Meas_rebin4_data_graph3005->GetXaxis()->SetTitleFont(42);
   Graph_m3lmet_Meas_rebin4_data_graph3005->GetYaxis()->SetLabelFont(42);
   Graph_m3lmet_Meas_rebin4_data_graph3005->GetYaxis()->SetLabelOffset(0.007);
   Graph_m3lmet_Meas_rebin4_data_graph3005->GetYaxis()->SetLabelSize(0.05);
   Graph_m3lmet_Meas_rebin4_data_graph3005->GetYaxis()->SetTitleSize(0.06);
   Graph_m3lmet_Meas_rebin4_data_graph3005->GetYaxis()->SetTitleOffset(1.35);
   Graph_m3lmet_Meas_rebin4_data_graph3005->GetYaxis()->SetTitleFont(42);
   Graph_m3lmet_Meas_rebin4_data_graph3005->GetZaxis()->SetLabelFont(42);
   Graph_m3lmet_Meas_rebin4_data_graph3005->GetZaxis()->SetLabelOffset(0.007);
   Graph_m3lmet_Meas_rebin4_data_graph3005->GetZaxis()->SetLabelSize(0.05);
   Graph_m3lmet_Meas_rebin4_data_graph3005->GetZaxis()->SetTitleSize(0.06);
   Graph_m3lmet_Meas_rebin4_data_graph3005->GetZaxis()->SetTitleFont(42);
   grae->SetHistogram(Graph_m3lmet_Meas_rebin4_data_graph3005);
   ...
   leg->SetFillColor(0);
   leg->SetFillStyle(1001);
   entry=leg->AddEntry("m3lmet_Meas_rebin4_total_errors","stat. unc.","F");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   entry->SetMarkerColor(1);
